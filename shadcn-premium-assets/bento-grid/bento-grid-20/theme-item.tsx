...
const ThemeItem = ({ theme, className, onClick }: ThemeItemProps) => {
  return (
    <div
      className={cn('flex cursor-pointer items-center gap-3 rounded-xl border px-3 py-2 transition-colors', className)}
      onClick={onClick}
    >
      <div className='size-6.25 shrink-0 rounded border'>

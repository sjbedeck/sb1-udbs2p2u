    ...
    <NavigationMenu viewport={false} className={cn('hidden lg:block', navigationClassName)}>
      <NavigationMenuList className='h-fit flex-wrap gap-6'>
        {navigationData.map(navItem => {
            ...
            return (
              <NavigationMenuItem key={navItem.title}>
                <NavigationMenuLink
                  ...
                  className={cn(
                    navigationMenuTriggerStyle(),
                    'text-primary-foreground! bg-transparent! p-0! text-base'
                  )}
                >
                  {navItem.title}
                </NavigationMenuLink>
          ...
          return (
            <NavigationMenuItem key={navItem.title}>
              <NavigationMenuTrigger className='text-primary-foreground! bg-transparent! p-0! text-base [&_svg]:size-4'>
                {navItem.title}
              </NavigationMenuTrigger>
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <SecondaryGrowButton size='icon' className={cn('inline-flex lg:hidden', triggerClassName)}>
          <MenuIcon />

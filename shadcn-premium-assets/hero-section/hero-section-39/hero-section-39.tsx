...
const HeroSection = () => {
  ...
  return (
    <section className='relative px-4 py-8 max-sm:pb-42 sm:px-6 sm:py-16 lg:px-8 lg:py-24'>
      ...
      <div className='space-y-12 sm:space-y-16 lg:space-y-24'>
        <div className='flex flex-col items-center gap-4'>
          ...
          <MotionPreset
            ...
            delay={0.2}
            component='h1'
            className='z-10 text-center text-3xl font-bold sm:text-4xl lg:text-5xl lg:leading-[1.29167]'
          >
          ...
          <div className='bg-background aspect-512/494 w-full max-w-5xl overflow-hidden rounded-xl border p-[1.318%]'>
            <div className='flex h-full w-full overflow-hidden rounded-lg border'>
              ...
              {scrollProgress >= 27 ? (
                <div className='w-1/5'>
                  <img
                    src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-15.png'
                    alt='Dashboard sidebar'
                    className='dark:hidden'
                  />
                  <img
                    src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-15-dark.png'
                    alt='Dashboard sidebar'
              ...
              <div className='flex w-4/5 flex-col'>
                ...
                {scrollProgress >= 27 ? (
                  <div>
                    <img
                      src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-14.png'
                      alt='Dashboard sidebar'
                      className='dark:hidden'
                    />
                    <img
                      src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-14-dark.png'
                      alt='Dashboard sidebar'
                      className='hidden dark:inline-block'
                    />
                  </div>
                ...
                <div className='grid grid-cols-3 gap-[1.266%] p-[1.266%]'>
                  ...
                  {scrollProgress >= 27 ? (
                    <MotionPreset
                      ...
                      className={cn('rounded-lg transition-all ease-out', {
                        'shadow-xl': scrollProgress >= 27 && scrollProgress < 37
                      })}
                    >
                      <img
                        src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-09.png'
                        alt='Dashboard sidebar'
                        className='dark:hidden'
                      />
                      <img
                        src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-09-dark.png'
                        alt='Dashboard sidebar'
                        className='hidden dark:inline-block'
                      />
                    </MotionPreset>
                  ...
                  {scrollProgress >= 27 ? (
                    ...
                    >
                      <img
                        src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-08.png'
                        alt='Dashboard sidebar'
                        className='dark:hidden'
                      />
                      <img
                        src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-08-dark.png'
                        alt='Dashboard sidebar'
                        className='hidden dark:inline-block'
                      />
                    </MotionPreset>
                  ...
                  {scrollProgress >= 27 ? (
                    ...
                    >
                      <img
                        src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-07.png'
                        alt='Dashboard sidebar'
                        className='dark:hidden'
                      />
                      <img
                        src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-07-dark.png'
                        alt='Dashboard sidebar'
                        className='hidden dark:inline-block'
                      />
                    </MotionPreset>
                ...
                <div className='grid grid-cols-3 gap-[1.266%] p-[1.266%] pt-0'>
                  <div className='flex flex-col justify-between'>
                    {scrollProgress >= 37 ? (
                      ...
                      >
                        <img
                          src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-04.png'
                          alt='Dashboard sidebar'
                          className='dark:hidden'
                        />
                        <img
                          src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-04-dark.png'
                          alt='Dashboard sidebar'
                          className='hidden dark:inline-block'
                        />
                      </MotionPreset>
                    ...
                    {scrollProgress >= 37 ? (
                      ...
                      >
                        <img
                          src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-11.png'
                          alt='Dashboard sidebar'
                          className='dark:hidden'
                        />
                        <img
                          src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-11-dark.png'
                          alt='Dashboard sidebar'
                          className='hidden dark:inline-block'
                        />
                      </MotionPreset>
                  ...
                  {scrollProgress >= 37 ? (
                    ...
                    >
                      <img
                        src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-10.png'
                        alt='Dashboard sidebar'
                        className='dark:hidden'
                      />
                      <img
                        src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-10-dark.png'
                        alt='Dashboard sidebar'
                        className='hidden dark:inline-block'
                      />
                    </MotionPreset>
                ...
                <div className='p-[1.266%] pt-0'>
                  {scrollProgress >= 47 ? (
                    ...
                    >
                      <img
                        src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-06.png'
                        alt='Dashboard sidebar'
                        className='dark:hidden'
                      />
                      <img
                        src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-06-dark.png'
                        alt='Dashboard sidebar'
                        className='hidden dark:inline-block'
                      />
                    </MotionPreset>
                ...
                {scrollProgress >= 47 ? (
                  <div>
                    <img
                      src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-13.png'
                      alt='Dashboard Footer'
                      className='dark:hidden'
                    />
                    <img
                      src='https://cdn.shadcnstudio.com/ss-assets/template/landing-page/flow/image-13-dark.png'
        ...
        >
          <div className='bg-primary text-primary-foreground flex items-center gap-10 rounded-xl px-3.5 py-2'>
            <div className='flex items-center gap-2 font-medium'>
              <FlowLogo className='size-8 rounded-full shadow-[0_10px_15px_-3px_color-mix(in_oklab,var(--primary-foreground)10%,transparent),0_4px_6px_-4px_color-mix(in_oklab,var(--primary-foreground)10%,transparent)]' />
              {scrollProgress < 27 && <span>Welcome to your dashboard</span>}

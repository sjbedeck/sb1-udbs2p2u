    ...
    <Card className={cn('justify-between', className)}>
      <CardHeader className='flex justify-between'>
        <div className='flex items-center gap-4'>
          ...
          <div className='flex flex-col gap-1'>
            <span className='text-lg font-medium'>Romeo Juliet drama</span>
            <span className='text-muted-foreground text-sm'>12 Dec 2025 at 10:00 PM</span>
          </div>
        </div>
        <DropdownMenu>
      ...
      <div className='flex flex-col gap-9'>
        <div className='relative'>
          <img
            src='https://cdn.shadcnstudio.com/ss-assets/blocks/marketing/hero/advertisement.png'
        ...
        <CardContent className='space-y-2'>
          <p>Experience the passionate and tragic love story of Romeo & Juliet like never before.</p>
          <div className='flex items-center gap-2'>
            <Badge className='bg-primary/10 text-primary rounded-sm'>Romance</Badge>
            <Badge className='bg-primary/10 text-primary rounded-sm'>Drama</Badge>
            <Badge className='bg-primary/10 text-primary rounded-sm'>Funny</Badge>
          </div>
        </CardContent>
      </div>
